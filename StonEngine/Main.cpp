...
LPCWSTR g_szAppName = L"StonEngine";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"StonEngineWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"StonEngineWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            ...
            g_game.get());
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"StonEngineWindowClass", g_szAppName, WS_POPUP,
